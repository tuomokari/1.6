...
namespace SystemsGarden.mc2.RemoteConnector.Handlers.PayrollIntegrationHandlerServer
{
    ...
    public static class PayrollConstants
    {
        ...
        #region other stuff
        /// <summary>
        /// If lunch break then default value is 2160000 => 6h
        /// </summary>
        public static readonly int MinDayLengthWithLunchBreak = 21600000;

        /// <summary>
        /// Lunchbreaktime is 1800000 => 0.5h
        /// </summary>
        public static readonly int LunchBreakTime = 1800000;
