...
namespace SystemsGarden.mc2.RemoteConnector.Handlers.PayrollIntegrationHandlerServer
{
    ...
    class Absence : EntryToPayroll
    {
        ...
        {
            var config = EntriesToPayroll<Absence>.ParsedConfig;
            var indexOfEntryType = 0; //needed from configuration "config.tree" validtypescountandtypes
            return EntriesToPayroll<Absence>.CreateCsvLineWithReflection(this, indexOfEntryType);
        }
